...
const App: React.FC = () => {
    return (
        <div className="App container-fluid">
            ...
            <br/>
            <small>Built using Reactjs and PicoCSS. Head to the <a href="https://github.com/WMuhl/sc2-coop-reference">GitHub page</a> if you want to submit additions or corrections.</small>
            <hr/>
            <div className="grid">
                <CommanderList/>
                <MapList/>
